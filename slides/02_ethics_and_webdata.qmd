...
1. R session, introduction to the tidyverse (and getting started with text data)
...
# 1. R session, introduction to the tidyverse (and getting started with text data) {background-color="#58748F"}
...
## Coding
- Download file **2_class_two.R** from [https://sebastianstier.com/ma_css25/material.html](https://sebastianstier.com/ma_css25/material.html)
...
Starting 30 April 2025: Presentations of thesis ideas

For that, you need to be able to collect some DBD for your research.
...
[Browse through Bauer et al. and explore the options for collecting DBD. Please try a few of the proposed APIs and code snippets.]{style="color:red;"}
...
# Thank you for your attention! See you on 12 March 2025 {background-color="#58748F"} 
